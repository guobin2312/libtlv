...
#if defined(CONFIG_LIBTLV_VARLEN_SUPPORT) && defined(CONFIG_LIBTLV_PADDING_SUPPORT)
#define LIBTLV_OPT_DEFAULT        LIBTLV_OPT_TVLVP
#elif defined(CONFIG_LIBTLV_VARLEN_SUPPORT)
#define LIBTLV_OPT_DEFAULT        LIBTLV_OPT_TVLVN
#elif defined(CONFIG_LIBTLV_PADDING_SUPPORT)
